...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all z-50">
      {/* Logo */}
      <Link to="/">
        <h1 className="text-2xl font-bold text-orange-600">Fresh Cart </h1>
      </Link>
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {user ? (
          <div className="relative group">
            ...
            <ul className="hidden group-hover:block absolute top-10 right-0 bg-white shadow-md rounded-md border-gray-200 py-2 w-32 z-40 text-sm">
              <li
